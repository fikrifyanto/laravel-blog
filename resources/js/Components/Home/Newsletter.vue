<template>
    <div
        class="relative isolate overflow-x-hidden lg:overflow-visible pb-16 pt-24"
    >
            ...
            >
                <div class="max-w-xl lg:max-w-lg">
                    ...
                    <div class="mt-6 flex max-w-md gap-x-4">
                        ...
                        <input
                            ...
                            autocomplete="email"
                            required
                            class="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-gray-900 shadow-sm ring-2 ring-inset ring-white/10 focus:ring-2 focus:ring-inset ring-indigo-500 sm:text-sm sm:leading-6"
                ...
                >
                    <div class="flex flex-col items-start">
                        ...
                        <dt class="mt-4 font-semibold text-gray-900">
                            Weekly articles
                        </dt>
        ...
        <div
            class="absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl md:-top-56"
            aria-hidden="true"
        >
            <div
