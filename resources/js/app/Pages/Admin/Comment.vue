        ...
        <div class="border shadow-sm rounded-md overflow-x-scroll overflow-y-hidden">
            <table class="table-auto w-full text-sm">
                <thead class="border-b border-slate-300 bg-slate-50">
                    ...
                    <th class="font-medium text-left py-4 px-6">Comment</th>
                ...
                <tbody>
                    <tr :class="{'border-b': row != 9}" v-for="row in 9">
                        <td class="py-4 px-6">fikrifyanto@gmail.com</td>
                        <td class="text-gray-600 py-4 px-6">Lorem ipsum dolor sit amet.</td>
                        <td class="text-gray-600 py-4 px-6">Lorem ipsum dolor sit amet.</td>
                        <td class="text-gray-600 py-4 px-6">24th January 20224</td>
